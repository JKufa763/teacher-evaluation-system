...
<html>
<head>
    <title>School Evaluation Report</title>
    <style>
...
<body>
    ...
    <table>
        ...
        <tr><td>Average Self Rating (out of 5)</td><td>{{ number_format($schoolAverage['avgSelfRating'], 2) }}</td></tr>
        <tr><td>Average Peer Rating (out of 5)</td><td>{{ number_format($schoolAverage['avgPeerRating'], 2) }}</td></tr>
        <tr><td>Average Student Rating (out of 5)</td><td>{{ number_format($schoolAverage['avgStudentRating'], 2) }}</td></tr>
        <tr><td>Average Weighted Rating (out of 5)</td><td>{{ number_format($schoolAverage['avgWeightedRating'], 2) }}</td></tr>
        @if($schoolAverage['avgSelfScore'] !== null)
            <tr><td>Average Self Performance Score (out of 40)</td><td>{{ number_format($schoolAverage['avgSelfScore'], 2) }}</td></tr>
        @endif
    </table>
    ...
    @foreach($departmentSummaries as $deptId => $summary)
        <h4>Department: {{ $summary['department']->name ?? 'Unknown' }}</h4>
        <table>
            <tr><th>Metric</th><th>Value</th></tr>
            <tr><td>Average Self Rating (out of 5)</td><td>{{ number_format($summary['avgSelfRating'], 2) }}</td></tr>
            <tr><td>Average Peer Rating (out of 5)</td><td>{{ number_format($summary['avgPeerRating'], 2) }}</td></tr>
            <tr><td>Average Student Rating (out of 5)</td><td>{{ number_format($summary['avgStudentRating'], 2) }}</td></tr>
            <tr><td>Average Weighted Rating (out of 5)</td><td>{{ number_format($summary['avgWeightedRating'], 2) }}</td></tr>
            @if($summary['avgSelfScore'] !== null)
                <tr><td>Average Self Performance Score (out of 40)</td><td>{{ number_format($summary['avgSelfScore'], 2) }}</td></tr>
            @endif
        </table>
        <div class="page-break"></div>
    @endforeach
